...
public class PrivateChatImpl extends QBMessageListenerImpl<QBPrivateChat> implements app.wingman.core.Chat, QBPrivateChatManagerListener {
    ...
    public PrivateChatImpl(app.wingman.ui.activities.ChatActivity chatActivity, Integer opponentID) {
