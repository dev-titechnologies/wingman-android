...
/**
 * Created by karthika on 16/11/2015.
 */
public class ChatService {

    private static final String TAG = app.wingman.core.ChatService.class.getSimpleName();

    static final int AUTO_PRESENCE_INTERVAL_IN_SECONDS = 30;

    private static app.wingman.core.ChatService instance;

    public static synchronized app.wingman.core.ChatService getInstance() {
        if(instance == null) {
            instance = new app.wingman.core.ChatService();
        }
        return instance;
    }
