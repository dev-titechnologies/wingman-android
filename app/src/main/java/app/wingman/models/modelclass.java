...
public class modelclass {
    ...
    public void setConnectionsString(String connectionsString) {
    ...
    public String getConnectionsGRoupId() {
        return connectionsGRoupId;
    }

    public void setConnectionsGRoupId(String connectionsGRoupId) {
        this.connectionsGRoupId = connectionsGRoupId;
    }

    public String connectionsGRoupId;

    public String getConnectionsUserId() {
        return connectionsUserId;
    }

    public void setConnectionsUserId(String connectionsUserId) {
        this.connectionsUserId = connectionsUserId;
    }

    public String connectionsUserId;
