...
public class PlayServicesHelper {
    ...
    private String getRegistrationId() {
        ...
        int currentVersion = app.wingman.ApplicationSingleton.getInstance().getAppVersion();
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    regId = googleCloudMessaging.register(app.wingman.pushnotifications.Consts.PROJECT_NUMBER);
    ...
    private void storeRegistrationId(String regId) {
        final SharedPreferences prefs = getGCMPreferences();
        int appVersion = app.wingman.ApplicationSingleton.getInstance().getAppVersion();
