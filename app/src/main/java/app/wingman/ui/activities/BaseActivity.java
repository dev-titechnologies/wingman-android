...
public class BaseActivity extends AppCompatActivity implements app.wingman.core.ApplicationSessionStateCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        boolean initialised = app.wingman.core.ChatService.initIfNeed(this);
...
//            user.setPassword(savedInstanceState.getString(USER_PASSWORD_KEY));
    ...
    private void recreateSession(final QBUser user){
        ...
        //
        app.wingman.core.ChatService.getInstance().login(user, new QBEntityCallbackImpl() {
            @Override
    ...
    protected void onSaveInstanceState(Bundle outState) {
        QBUser currentUser = app.wingman.core.ChatService.getInstance().getCurrentUser();
        if(currentUser != null) {
