...
import app.wingman.ui.adapters.UsersAdapter;

public class NewDialogActivity extends app.wingman.ui.activities.BaseActivity implements QBEntityCallback<ArrayList<QBUser>> {
    ...
    public void onBackPressed() {
        Intent i = new Intent(NewDialogActivity.this, app.wingman.ui.activities.DialogsActivity.class);
        startActivity(i);
        finish();
    }
    ...
    public void onSuccess(ArrayList<QBUser> newUsers, Bundle bundle){
        ...
        //
        usersAdapter = new app.wingman.ui.adapters.UsersAdapter(users, this);
